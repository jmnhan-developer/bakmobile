        ...
        <View style={styles.contentView}>
          ...
          <View style={{ backgroundColor: "rgba(46, 50, 72, 1)", width: SCREEN_WIDTH, alignItems: "center" }}>
            ...
            {{ borderRadius: 40, 
              ...
              returnKeyType="next" ref={input => (this.email2Input = input)} onSubmitEditing={() => {
              this.password2Input.focus();
            }} blurOnSubmit={false} />
            <Input containerStyle={{ borderRadius: 40, borderWidth: 1, borderColor: "rgba(110, 120, 170, 1)", height: 50, width: SCREEN_WIDTH - 50, marginVertical: 10 }} 
              ...
              returnKeyType="next" ref={input => (this.password2Input = input)} onSubmitEditing={() => {
